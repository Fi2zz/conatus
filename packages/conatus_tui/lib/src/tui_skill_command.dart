/// 技能斜杠命令：把技能注册表投影成 `/<技能名>` 命令，并负责展开与折叠。
///
...
/// [renderSkillPrompt] 的逆操作：把展开的正文块折叠回 `/<技能名> <补充要求>`。
///
